    ...
    return (
        <Container fluid>
            <Row className="" style={{justifyContent: 'space-evenly'}}>
                <div className="col-sm-8 col-md-6  col-lg-4 m-4"
                     style={{backgroundColor: "#ffffff", borderStyle: "groove", paddingBottom: "8px"}}>
                    <Doughnut data={data} options={weeklyOptions}/>
                </div>
                <div className="col-sm-8 col-md-6 col-lg-4 m-4"
                     style={{backgroundColor: "#ffffff", borderStyle: "groove", paddingBottom: "8px"}}>
                    <Doughnut className="col-sm-6" data={monthlyData} options={monthlyOptions}/>
                </div>
            </Row>
        </Container>
